...
class OutputFormatter implements OutputFormatterInterface {
        ...
        public function __construct($decorated = null, array $styles = array()) {
                ...
                $this->styleStack = new OutputFormatterStyleStack(new OutputFormatterStyle());
        }
         ...
         * @api
         */
        public function setStyle($name, \Symfony\Component\Console\Formatter\OutputFormatterStyleInterface $style) {
